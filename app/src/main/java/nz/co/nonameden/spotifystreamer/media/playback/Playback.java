 ...
 */
package nz.co.nonameden.spotifystreamer.media.playback;

import android.support.v4.media.session.MediaSessionCompat;

/**
 * Interface representing either Local or Remote Playback. The {@link nz.co.nonameden.spotifystreamer.media.MusicPlayerService} works
